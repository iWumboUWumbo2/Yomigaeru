...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary
{
    ...
    if (self)
    {
        ...
        _thumbnailUrl = [[YGRSettingsManager sharedInstance] URLForPath:[dictionary objectForKey:@"thumbnailUrl"]];
        _thumbnailUrlLastFetched = [[dictionary objectForKey:@"thumbnailUrlLastFetched"] integerValue];
        ...
        _updateStrategy = [YGRUpdateStrategyUtility updateStrategyFromString:[dictionary objectForKey:@"updateStrategy"]];
        ...
        _lastChapterRead = (lastChapterReadValue != nil && ![lastChapterReadValue isEqual:[NSNull null]])
...
- (NSString *)description {
    return [NSString stringWithFormat:
            ...
            self.title,
            self.thumbnailUrl,
            (long)self.thumbnailUrlLastFetched,
            ...
            self.inLibrary ? @"YES" : @"NO",
            (long)self.inLibraryAt,
            self.source,
            self.meta,
            self.realUrl,
            (long)self.lastFetchedAt,
            (long)self.chaptersLastFetchedAt,
            [YGRUpdateStrategyUtility stringFromUpdateStrategy:self.updateStrategy],
            self.freshDate ? @"YES" : @"NO",
            (long)self.unreadCount,
            (long)self.downloadCount,
            (long)self.chapterCount,
            (long)self.lastReadAt,
            self.lastChapterRead,
            (long)self.age,
            (long)self.chaptersAge,
            self.trackers];
}
