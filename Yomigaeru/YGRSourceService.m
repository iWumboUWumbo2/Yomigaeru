...
- (void)fetchPopularMangaFromSourceId:(NSString *)sourceId
                           ...
                           completion:(void (^)(NSArray *mangaList, BOOL hasNextPage, NSError *error))completion
{
    NSString *endpoint = [NSString stringWithFormat:@"source/%@/popular/%tu",
                          sourceId, pageNum];
...
- (void)fetchLatestMangaFromSourceId:(NSString *)sourceId
                          ...
                          completion:(void (^)(NSArray *mangaList, BOOL hasNextPage, NSError *error))completion
{
    NSString *endpoint = [NSString stringWithFormat:@"source/%@/latest/%tu",
                          sourceId, pageNum];
                   ...
                   completion:(void (^)(NSArray *mangaList, BOOL hasNextPage, NSError *error))completion
{
    ...
    NSString *endpoint = [NSString stringWithFormat:
                          @"source/%@/search?searchTerm=%@&pageNum=%tu",
                          sourceId, encoded, pageNum];
