...
- (void)fetchAllExtensionsWithCompletion:(void (^)(NSArray *extensions, NSError *error))completion
{
    ...
    [jsonClient getPath:@"extension/list" parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
- (void)installExtensionWithPackageName:(NSString *)pkgName completion:(void (^)(BOOL, NSError *))completion {
    [self performExtensionAction:@"install" packageName:pkgName completion:completion];
}

- (void)updateExtensionWithPackageName:(NSString *)pkgName completion:(void (^)(BOOL, NSError *))completion {
    [self performExtensionAction:@"update" packageName:pkgName completion:completion];
}

- (void)uninstallExtensionWithPackageName:(NSString *)pkgName completion:(void (^)(BOOL, NSError *))completion {
